...
const SECCIONES = [
  ...
  { href: "/admin/usuarios", etiqueta: "Cuentas", detalle: "Quiénes reservan" },
  { href: "/admin/consultas", etiqueta: "Consultas", detalle: "El chat del sitio" },
  { href: "/admin/productos", etiqueta: "Productos", detalle: "Catálogo de la tienda" },
  { href: "/admin/blog", etiqueta: "Blog", detalle: "Las notas de la casa" },
